...
const SelectComponents = ({label, value, onchange, options=[]}) => {
  return (
    <div className='relative'>
      ...
      <select value={value} onChange={onchange} className='border placeholder-gray-400 focus:outline-none focus:border-black w-full pt-4 pb-4 text-base block bg-white border-gray-300 rounded-md'>
        {
