    ...
    <div className='py-14 px-4 md:px-6'>
      ...
      <div className='mt-10 flex flex-col justify-center xl:flex-row items-stretch w-full xl:space-x-8 md:space-y-6 xl:space-y-0'>
        <div className='flex flex-col justify-start items-start w-full space-y-4 md:space-y-6 xl:space-y-8'>
          <div className='flex flex-col justify-start items-start bg-gary-50 px-4 py-4 md:p-6 xl:p-8 w-full'>
            <p className='font-bold text-lg'>Your Order Summery</p>
            {
              orderDetails && orderDetails.orderItems && orderDetails.orderItems.length ?
                orderDetails.orderItems.map(item => (
                  <div key={item._id} className='mt-4 md:mt-6 flex flex-col md:flex-row justify-start items-start md:items-center md:space-x-5 xl:space-x-8 w-full'>
                    <div className='pb-4 md:pb-8 w-full md:w-40'>
                      <img src={item && item.product && item.product.imageUrl} alt='itemImg' className='w-full hidden md:block' />
                    </div>
